...
const getAboutPage = (req,res) => {
    ...
    const getRegisterPage = (req,res) => {
        ...
        const getLoginPage = (req,res) => {
            ...
            const getLogout = (req,res) => { //! bunun mantığını tam anlayamadım ama bunu yaparak, cookie de kayıtlı olan tokenımızı uçuruyoruz.
                res.cookie("jwt","", {
                    maxAge: 1 // 1 milisaniye 
                });
                res.redirect("/");
                }

                const getContactPage = (req,res) => {
                    res.render("contact", { // contact view dosyasını render edecek.
                        link : "contact"
                    });
                    }
  ...
  // send mail with defined transport object
   await transporter.sendMail({
    to: "cuneytercel@gmail.com", // list of receivers
